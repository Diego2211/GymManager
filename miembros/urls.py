from miembros.views import index, miembros, clases, clase, ingreso_miembro, inscribir_alumno, crear_clase, profesores, eventos, ver_calendario, avisos, editar_inscripcion, baja_inscripcion, reactivar_inscripcion, registrar_pago, editar_clase, eliminar_clase, editar_alumno, eliminar_alumno, expulsar_profesor
...
urlpatterns = [
    ...
    path("expulsar-profesor/<int:membership_id>/", expulsar_profesor, name="expulsar profesor"),
]